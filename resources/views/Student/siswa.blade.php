        ...
        <div class="card">
          <div class="card-body">
            ...
            <tr>
                ...
                <td><a href="{{ route('siswa.edit', $siswa->id) }}"><i class="bi bi-pencil-square"></i></a></td>
                <td>
                  <a href="{{ route('siswa.hapus', $siswa->id) }}" onclick="return confirm('Yakin ingin menghapus data ini?')">
